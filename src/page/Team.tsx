...
const Team = () => {
    return (
        <ComeUpPageWrapper>
            <div className="flex m-auto flex-col sm:flex-row justify-between gap-8 mb-14 max-w-[1200px]">
            ...
            <div className='m-auto'>
                <div className="flex flex-wrap  gap-5 m-auto max-w-[1200px]">
                    <LeaderCard className='lg:w-[31.5%] sm:w-[48%]'  name='John doe' designation='CTO' />
                    <LeaderCard className='lg:w-[31.5%] sm:w-[48%]'  name='John doe' designation='CTO' />
                    <LeaderCard className='lg:w-[31.5%] sm:w-[48%]'  name='John doe' designation='CTO' />
                    <LeaderCard className='lg:w-[31.5%] sm:w-[48%]'  name='John doe' designation='CTO' />
                    <LeaderCard className='lg:w-[31.5%] sm:w-[48%]'  name='John doe' designation='CTO' />
